...
Go to the [Secrets page](https://github.com/milesrichardson/connector-demo/settings/secrets/actions/new) for this
...
going to https://github.com/milesrichardson/connector-demo/actions/workflows/build.yml and clicking "Run workflow". 
